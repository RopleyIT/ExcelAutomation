    ...
    internal class ChartSample
    {
        ...
        static void InsertChartInSpreadsheet(string docName, string worksheetName, string title, Dictionary<string, int> data)
        {
            ...
            using (SpreadsheetDocument document = SpreadsheetDocument.Open(docName, true))
            {
                ...
                DrawingsPart drawingsPart = worksheetPart
                    .AddNewPart<DrawingsPart>();
                ...
                chartPart.ChartSpace.Append
                    (new EditingLanguage() { Val = new StringValue("en-US") });
                ...
                BarChart barChart = plotArea.AppendChild<BarChart>
                    (new BarChart(new BarDirection()
                { Val = new EnumValue<BarDirectionValues>(BarDirectionValues.Column) },
                    new BarGrouping() { Val = new EnumValue<BarGroupingValues>
                ...
                {
                    BarChartSeries barChartSeries = barChart
                        .AppendChild<BarChartSeries>(new BarChartSeries(new Index()
                    {
                    ...
                    StringLiteral strLit = barChartSeries
                        .AppendChild<CategoryAxisData>
                    ...
                    { Index = new UInt32Value(0U) }).Append(new NumericValue(title));

                    NumberLiteral numLit = barChartSeries
                        .AppendChild<DocumentFormat.OpenXml.Drawing.Charts.Values>(
                    ...
                    { Index = new UInt32Value(0u) }).Append
