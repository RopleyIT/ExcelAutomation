...
public sealed class XlDocumentTests
{
    ...
    {
        using XlDocument doc = XlDocument.Open("C:\\tmp\\Book1.xlsx");
    ...
    public void CanAddSheetToWorkbook()
    {
        ...
        using XlDocument doc = XlDocument.Open("C:\\tmp\\Book2.xlsx");
    ...
    public void CanReopenAndReadCells()
    {
        ...
        using XlDocument doc2 = XlDocument.Open("C:\\tmp\\Book2.xlsx");
    ...
    public void SharedStringsDeletedAfterFinalUse()
    {
        ...
        using (XlDocument doc3 = XlDocument.Open("C:\\tmp\\Book2.xlsx"))
        {
        ...
        using (XlDocument doc4 = XlDocument.Open("C:\\tmp\\Book2.xlsx"))
        {
